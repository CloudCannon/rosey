Feature: Rosey Build Combinatorial
  ...
  Scenario: Rosey builds from source.json [ns, root, attr, explicit-attr]
    ...
    Then I should see a selector '[data-rosey]' in "dest/test/index.html" with the attributes:
      | data-rosey | title |
      | innerText | one |
    Then I should see a selector '[data-rosey]' in "dest/test/index.html" with the attributes:
      | data-rosey | title |
    ...
    Then I should see a selector '[data-rosey]' in "dest/test/index.html" with the attributes:
      ...
      | innerText | six |
    Then I should see a selector '[data-rosey-attrs-explicit]' in "dest/test/index.html" with the attributes:
