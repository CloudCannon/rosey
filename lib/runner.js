...
module.exports = {
    ...
    build: async function( options ) {
        ...
        await this.addCharacterBasedWordwraps(options);
    ...
    /**
     * Creates a new locale for Japanese translations at i18n/wrapped/. 
     * This new locale has added span tags to wordwrap characters more appropriately. 
     * This requires a Google Cloud Natural Language API key to be set:
     * @param {Object} options The options object.
     */
    addCharacterBasedWordwraps: async function( options ) {
