...
module.exports = {
  parse(options, callback) {
    ...
    return this.segment(options.text, options.language, client).then((chunks) => {
  ...
  getSourceChunks(text, language, client) {
  ...
  getAnnotations(text, language, client) {
  ...
  callClientApi(requestBody, client) {
