Feature: Rosey Build Meta
  ...
  Scenario: Rosey adds alternates to prelocalised files
    Given I have a "dist/site/index.html" file with the content:
      """
      <html>
      </html>
      """
    And I have a "dist/site/blank/index.html" file with the content:
      """
      <html>
      </html>
      """
    ...
    When I run my program with the flags:
      | build |
    Then I should see a selector 'link' in "dist/translated_site/index.html" with the attributes:
      | rel      | canonical         |
      | href     | /en/              |
      | hreflang | en                |
    Then I should see a selector 'link' in "dist/translated_site/index.html" with the attributes:
    ...
    Then I should see a selector 'link' in "dist/translated_site/nada/index.html" with the attributes:
      | rel      | alternate         |
      | href     | /en/              |
      | hreflang | en                |
    Then I should see a selector 'link' in "dist/translated_site/nada/index.html" with the attributes:
